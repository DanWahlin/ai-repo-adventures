 ...
 * 3. explore_adventure_quest - Explores individual quest adventures (can be called multiple times)
...
import { exploreAdventureQuest, setAdventureManager as setExploreAdventureQuestManager } from './explore-adventure-quest.js';
...
export const explore_adventure_quest = exploreAdventureQuest;
