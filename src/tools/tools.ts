 ...
 * 3. explore_adventure_path - Explores individual adventures (can be called multiple times)
...
import { exploreAdventurePath, setAdventureManager as setExploreAdventurePathManager } from './explore-adventure-path.js';
...
setExploreAdventurePathManager(adventureManager);
...
export const explore_adventure_path = exploreAdventurePath;
